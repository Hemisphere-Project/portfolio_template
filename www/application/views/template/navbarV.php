<div id="navbar-v">
    <div id="logo"  ><a href="<?php echo site_url('projects/prjkts/projects_strip'); ?>" target="_self"><img src="<?php echo base_url('imgs/logo200.png'); ?>"/></a></div>
    <ul>
<!--<li><div id="LBtn" class="left-group-button"><a href="<?php echo site_url('projects/prjkts/projects_list'); ?>" target="_self">PROJECTS LIST</a></div></li>
    ...
    <li><div id="SBtn" class="left-group-button"><a href="<?php echo site_url('projects/prjkts/projects_strip'); ?>" target="_self">PROJECTS STRIP</a></div></li>-->
